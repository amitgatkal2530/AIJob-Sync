...
return(
    <div className="mt-20 flex items-center bg-mine-shaft-900 mx-20 py-3 rounded-xl justify-around">
         <div className="text-4xl w-2/5 text-center font-semibold  text-mine-shaft-100">Never
        <span className="text-bright-sun-400"> Wants </span> to  Miss Any{" "}
      ...
      <div className="flex gap-4 rounded-xl bg-mine-shaft-700 px-3 py-2 items-center">
         ...
         variant="unstyled"
         placeholder="Your@gmail.com" size="xl"/>
